      ...
      <div className='suite-modal'>
        <div className='suite-modal-header'>
          ...
          <div className='suite-badge-container'>
            <div className='pill'><Badge pill bg='primary'>{numberToAcronym(this.props.suiteStats.noBeds)}</Badge></div>
            <div className='pill'><Badge pill bg='secondary'>Noise: {this.props.suiteStats.noise} </Badge></div>
            <div className='pill'><Badge pill bg='info'> Size: {this.props.suiteStats.size} </Badge></div>      
          </div>
        </div>

        <div className='suite-modal-card-container'>
          {this.props.rooms.map((room) => (
            <BedroomCard key={room.roomCode} room={room} handleFavorited={this.handleFavorited} handleActivateReview={this.activateReview}/>
          ))}
        </div>
