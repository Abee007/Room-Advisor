...
export default class ReviewRoomModal extends Component {
    ...
    uploadPictures = async (files, roomCode) => {
        ...
        for(const file of files) {
            ...
            const storageRef = ref(this.state.storage, `${this.props.college}-${roomCode}-${count}`);
    ...
    handleAddReview = async (e) => {
        ...
        const fileLinks = await this.uploadPictures(e.target.roomPictures.files, e.target.roomCode.value);
                ...
                <div className="submit-review-form-container">
                    <form onSubmit={this.handleAddReview}>
                        <div className="picture-upload-container">
                            ...
                            <input multiple type="file" id="roomPictures" name="roomPictures" accept="image/png, image/jpeg" />
