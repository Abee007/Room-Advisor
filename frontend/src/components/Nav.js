...
// }
  ...
  return (
    <div className='navbar-header'>
      <header>
        <nav>
          <div className='navbar-container'>
            ...
            <div className='menu'>
              <NavLink to='/about' className='navbar-link' activeClassName='is-active'>About</NavLink>
              {props.user !== undefined ? <NavLink to='/logout' className='navbar-link' activeClassName='is-active'>Logout</NavLink> : ''}
            </div>

            <button class={isActiveHamburger ? 'hamburger is-active' : 'hamburger'} onClick={toggleActiveHamburger}>
              <span></span>
              <span></span>
              <span></span>
            </button>
      ...
      <nav className={isActiveHamburger ? 'mobile-nav is-active': 'mobile-nav'}>
        <NavLink to='/about' className='navbar-link' activeClassName='is-active'>About</NavLink>
        {props.user !== undefined ? <NavLink to='/logout' className='navbar-link' activeClassName='is-active'>Logout</NavLink> : ''}
      </nav>
    </div>
